    ...
    do
    {
       ...
       switch (opcode)
       {
           ...
           case 33: //FACE_TWINKEL
           {
               ...
               distance = *(short int *) scriptPtr;
               scriptPtr += 2;
               sprintf(scriptbuff,"FACE_TWINKEL %d", distance);
           ...
           case 34: // ANGLE_RND
           {
               ...
               angle1 = *(short int *) scriptPtr;
               scriptPtr += 2;
               time = *(short int *) scriptPtr;
               scriptPtr += 2;
               sprintf(scriptbuff,"ANGLE_RND %d %d", angle1, time);
               break;
           }
           default:
           {
    ...
    do
    {
        ...
        switch(opcode)
        {
            ...
            case 33: // FACE_TWINKEL
             ...
             case 13: // WAIT_NB_ANIM  1 byte used, 1 byte dummy    <<---RECHECK
                {
                    track.script=(unsigned char*)realloc((unsigned char*)track.script,currentOffset+3);
